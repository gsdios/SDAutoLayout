Pod::Spec.new do |s|
  ...
  s.name         = "SDAutoLayout"
  s.version      = "2.0.0"
  s.summary      = "The most easy way for autoLayout.    2.0.0版本更新内容：增加设置偏移量offset功能；修复用xib生成的view出现的部分约束失效问题"
  ...
  s.source       = { :git => "https://github.com/gsdios/SDAutoLayout.git", :tag => "2.0.0"}
